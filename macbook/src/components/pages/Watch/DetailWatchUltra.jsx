    ...
    <>
      <div className="w-full px-5 md:px-10 lg:px-20 2xl:px-0 max-w-7xl mx-auto mt-[100px]">
          ...
          <div data-aos="fade-down" className="mt-[70px]">
            ...
            <h1 className="text-gray text-xl mt-5">Your ultimate health care tool.</h1>
  ...
  >
    {">"}
        ...
        <div className="mt-[125px]">
            ...
            <h1 className="text-6xl font-extrabold text-center text-white mt-5">The battery is designed for longevity.</h1>
            <h1 className="text-center mt-10 text-xl">The Apple Watch Ultra 3 is designed to give you even longer battery life, <br /> so you can go further and wider than ever before. <br />
                 When you need a power boost, you can fast charge it for just 15 minutes for up to 12 hours of normal use.</h1>
            <div className="w-full mt-[90px] px-5 md:px-10 lg:px-20 2xl:px-0 max-w-7xl mx-auto grid grid-cols-2 gap-[40px] flex justify-around">
              <div className="">
      ...
      <div className="relative w-full mt-[160px]">
        ...
        <div className="absolute top-50 left-50 text-white text-2xl md:text-4xl font-semibold">
          <h1 className="font-bold text-2xl">Add more sports</h1>
          <h1 className="font-bold text-6xl mb-6 bg-gradient-to-r from-green-400 via-sky-700 to-red-400 bg-clip-text text-transparent">The all-around champion.</h1>
          <h1 className="text-2xl">The Apple Watch Ultra 3 elevates your capabilities in every sport.</h1>
          <h1 className="text-2xl">When you're cycling, it actively tracks your speed and performance</h1>
          <h1 className="text-2xl">so you can see your progress in real time. And when you're</h1>
          <h1 className="text-2xl">n the water, it can track your swim laps, automatically detect</h1>
          <h1 className="text-2xl">your strokes, and calculate your total distance for you. </h1>
          <h1 className="text-2xl">It's time to achieve your best.</h1>
