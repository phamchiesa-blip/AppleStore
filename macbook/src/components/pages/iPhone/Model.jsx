...
const Model = () => {
  ...
  return (
    <section className="sm:py-32 py-20 sm:px-10 px-5 ml-[3%]">
        ...
        <div className="flex flex-col items-center mt-5">
          ...
          <div className="mx-auto w-full mt-[-50px]">
            ...
            <div className="flex-center">
              <ul className="flex items-center justify-center px-4 py-4 rounded-full bg-[#262626] backdrop-blur">
                {models.map((item, i) => (
                  <li key={i} className="w-6 h-6 rounded-full mx-2 cursor-pointer" style={{ backgroundColor: item.color[0] }} onClick={() => setModel(item)} />
                ))}
              </ul>

              <button className="flex items-center justify-center p-1 rounded-full bg-[#262626] backdrop-blur ml-3 gap-1 cursor-pointer">
