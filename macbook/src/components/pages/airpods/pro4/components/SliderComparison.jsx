            ...
            <div ref={containerRef} className="relative w-full max-w-[1200px] h-[60vh] md:h-[80vh] cursor-col-resize select-none overflow-hidden touch-none rounded-[3rem] border border-white/10" onPointerDown={() => setIsDragging(true)}>
                <div className="absolute inset-0 bg-[#141010] flex items-center justify-center pointer-events-none">
                    ...
                    <div className="absolute bottom-12 right-12 z-20 flex flex-col items-end">
                        <div className="text-orange-500 font-bold uppercase tracking-widest bg-zinc-900/90 backdrop-blur-md px-6 py-2 rounded-full border border-orange-500/40 text-xs md:text-sm shadow-[0_0_30px_rgba(249,115,22,0.2)]">Normal Mode</div>
                        <p className="text-orange-200/50 text-sm mt-3 font-medium bg-black/60 px-4 py-1 rounded-full backdrop-blur-md">Chaotic Background Noise</p>
                    </div>
                </div>
                <div ref={topLayerRef} className="absolute inset-0 bg-[#000000] flex items-center justify-center pointer-events-none will-change-transform z-10" style={{ clipPath: "polygon(0 0, 50% 0, 50% 100%, 0 100%)" }}>
                    ...
                    <div className="absolute bottom-12 left-12 z-20 flex flex-col items-start">
                        <div className="text-cyan-400 font-bold uppercase tracking-widest bg-cyan-950/80 backdrop-blur-md px-6 py-2 rounded-full border border-cyan-500/50 text-xs md:text-sm shadow-[0_0_40px_rgba(6,182,212,0.4)]">With ANC</div>
                        <p className="text-cyan-400/70 text-sm mt-3 font-medium bg-black/40 px-4 py-1 rounded-full backdrop-blur-md border border-cyan-500/10">Pure Silence</p>
                    </div>
                </div>
